...
class PaymentTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let insurance_id = payment.policy_id
...
let customer_id = insurance?.customer_id
        ...
        cell.detailTextLabel?.text = "Status: \(payment.status ?? "pending") Policy ID: \(insurance_id) Customer Name: \(customer?.name ?? "")"
        return cell
    }
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        if searchText.isEmpty {
            ...
            if(filteredResults.isEmpty) {
                let alert = UIAlertController(title: "No results", message: "No payments found", preferredStyle: .alert)
                alert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
                present(alert, animated: true, completion: nil)
            }
        }
